#!/usr/bin/env python3
"""
Simple script to convert NMR_plddt.json to FASTA format
"""
...
if __name__ == "__main__":
    # Convert the NMR_plddt.json file to FASTA
    json_to_fasta("new_embeddings/NMR_plddt.json", "nmr_sequences.fasta") 